...
const parsedUrl = url.parse("https://www.google.com/search?q=%EC%8A%A4%EC%A6%88%EB%A9%94&sxsrf=AJOqlzWfkSdrjufL5t-_UvgpWUxwVU84yw:1678865126689&ei=5nIRZJ3eKemg1e8Pl82iqAg&start=20&sa=N&ved=2ahUKEwid6YH8s939AhVpUPUHHZemCIUQ8tMDegQIAxAG&biw=1440&bih=711&dpr=2");
const query=queryString.pars햣e(parsedUrl.query);
console.log(query)
console.log(`queryStringfy:`,queryString.stringify(query))
